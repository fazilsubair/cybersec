...
/* john add UTF-8,允许普通的UTF-8汉字作为SSID */
function isValidSSID(val)
{
	var reg = /[\u4e00-\u9fa5]/g;
	var ssid = val.replace(reg, "");	
	return isValidAscii(ssid);
}

function getSSIDByteLen(val)
{
	var total = 0, i, len, charCode;
