...
var VOIPSupport = "<%tcWebApi_get("WebCustom_Entry","isVOIPSupported","s")%>";

var isACLSupport = "<%tcWebApi_get("WebCustom_Entry","isACLSupported","s")%>";
var isKeywordFilterSupported = "<%tcWebApi_get("WebCustom_Entry","isKeywordFilterSupported","s")%>";
var isParentalControlSupported = "<%tcWebApi_get("WebCustom_Entry","isParentalControlSupported","s")%>";
var isUpgradePageShow = "<%tcWebApi_get("WebCustom_Entry","isUpgradePageShow","s")%>";
...
<% if tcWebApi_get("WebCustom_Entry", "isBUCPESupported", "h") = "Yes"  then %>
...
<% if tcWebApi_get("WebCustom_Entry", "isParentalControlSupported","h") = "Yes" then%>
pageMap[3][5] = "<% tcWebApi_get("dynDisp_Entry","CurMaskBit4","s") %>";
<% else %>
pageMap[3][5] = 0;
<% end if %>
<% if tcWebApi_get("WebCustom_Entry", "isKeywordFilterSupported","h") = "Yes" then%>
pageMap[3][6] = "<% tcWebApi_get("dynDisp_Entry","CurMaskBit5","s") %>";
<% else %>
pageMap[3][6] = 0;
<% end if %>
<% if tcWebApi_get("WebCustom_Entry", "isACLSupported","h") = "Yes" then%>
