...
function setDigitMapValue()
{
		...
		if(len > 4096){
			alert("The maximum length of the dial rule cannot be greater than 4096");
			return -1;
		}
...
function generatePerLineTable() {
   ...
   if (document.body.innerHTML) {
      ...
      // Ptime row
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Ptime Setting <\/td>"
      var selectOptions0 = Array();
      ...
      //////////////////////////////////////////
      tableHtmlOutput += "<br>";
      tableHtmlOutput += "<b>Volume Setting(db)</b><br>";
      ...
      // Volume row
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Speaking Volume<\/td>"
      ...
      tableHtmlOutput += "</tr>";
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Listening Volume<\/td>"
      ...
      //////////////////////////////////////////
      tableHtmlOutput += "<br>";
      tableHtmlOutput += "<b>Supplementary Service Setting</b><br>";
      ...
      // Warm Line row
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Hotline Enable<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Hotline Number<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Hotline Delay Time (s)<\/td>"
      ...
      // Call waiting row
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >SIP Call Waiting<\/td>"
      ...
      /*zhangcg: 20110612*/
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >SIP Call Transfer<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Forward Number<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Unconditional Call Forwarding<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Busy Call Forward<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >No Reply Call Forward<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >No Reply Call Forward Waiting Time<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Three-Way Conference<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Server Voice Remix<\/td>"
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Resource Access Code for Three-Way Conference<\/td>"
    ...
    //caller id mode
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Call ID Mode <\/td>"
      var selectOptions0 = Array();
      ...
      //subscribe type
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Subscription Type <\/td>"
      var selectOptions0 = Array();
      selectOptions0[0] = "<option value=" + 0 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "0" then asp_Write("selected") end if %>>" + "No Subscription";
      selectOptions0[1] = "<option value=" + 1 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "1" then asp_Write("selected") end if %>>" + "Subscribe to the business";   
      selectOptions0[2] = "<option value=" + 2 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "2" then asp_Write("selected") end if %>>" + "Subscription registration";
      selectOptions0[3] = "<option value=" + 3 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "3" then asp_Write("selected") end if %>>" + "Subscribe to all";   
      tableHtmlOutput += "<td align=center><select name='DivSubscribeType0'>" + selectOptions0.join("") + "<\/select></td>";
                  
      <% if tcwebApi_get("VoIPBasic_Common","VoIPLine2Enable","h") = "Yes" then %>       
      var selectOptions1 = Array();
      selectOptions1[0] = "<option value=" + 0 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "0" then asp_Write("selected") end if %>>" + "No Subscription";
      selectOptions1[1] = "<option value=" + 1 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "1" then asp_Write("selected") end if %>>" + "Subscribe to the business";   
      selectOptions1[2] = "<option value=" + 2 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "2" then asp_Write("selected") end if %>>" + "Subscription registration";
      selectOptions1[3] = "<option value=" + 3 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "3" then asp_Write("selected") end if %>>" + "Subscribe to all";   
      tableHtmlOutput += "<td align=center><select name='DivSubscribeType1'>" + selectOptions1.join("") + "<\/select></td>";
      <% end if %>
      tableHtmlOutput += "</tr>";

      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Subscription Cycle(s)<\/td>"
	...
	//flash hook interval 
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Flash Hook Min Interval(ms)<\/td>"
      ...
      tableHtmlOutput += "</tr>";
	    ...
	    tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Flash Hook Max Interval(ms)<\/td>"
      ...
      tableHtmlOutput += "</tr>";
	    tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Hook Release Min(ms)<\/td>"
	...
	//Synchronize phone date time
	    tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >Synchronize Phone Date Time<\/td>"
      ...
      tableHtmlOutput += "<tr>";      
      tableHtmlOutput += "<td >Special Digitmap Enable<\/td>"
      ...
      tableHtmlOutput += "<tr>";      
      tableHtmlOutput += "<td >PBX Prefix Enable<\/td>"
      ...
      tableHtmlOutput += "<td >PBX Prefix<\/td>"    
      ...
      tableHtmlOutput += "<tr>";      
      tableHtmlOutput += "<td >PBX Dial Secondary Enable<\/td>"
    ...
    var regDigitMap = /[^0-9\[\]\-\|\.\*#xXABCDTLStlsEF]/g;
		...
		if (cb_DigitMapSpecialEnable.checked)
		{
			if(regDigitMap.test(getElById('txt_DigitMapSpecial').value)){
				alert("There is an invalid character in a specific number of map");
				return;
			}
		}
		if (cb_DigitMapEnable.checked){		
			if(regDigitMap.test(getElById('txt_DigitMap').value)){
				alert("There is an invalid character in a normal number of map");
				return;
			}
...
<%end if%>
	...
	<%end if%>
    {
        ...
        for (var j = 0;j < codecList.length;j++)
	      {
	          ...
	          alert("Duplicated speech coding priority setting");
	          return;
		      }
		    }
				if(codecNew == 0)
			...
			if(zz == 4)
		  {
		    alert("Cannot disalbe all the voice coding, please select one at least");
				return;
			}
	  }
	  ...
	  var temp = parseInt(ingressGain1.value);	
		if (temp < -12 || temp > 12)
		{
			alert('Vol Tx ranges in -12~12db.');
			return;
		}		
	    <%end if%>
		...
		if (temp < -12 || temp > 12)
		{
			alert('Vol Rx ranges in -12~12db.');
			return;
		} 
		...
		if (temp < 1 || temp > 1000)
		{
			alert('jitter buffer The maximum ranges in 1~1000.');
			return;
		}
		...
		if (temp < 96 || temp > 127)
		{
			alert('RTP redundancy payload type ranges in 96~127.');
			return;
		}		
		...
		if (temp < 0 || temp > 7)
		{
			alert('SIP 802.1p ranges in 0~7.');
			return;
		}	
		...
		if (temp < 0 || temp > 7)
		{
			alert('RTP 802.1p ranges in 0~7.');
			return;
		}	
		...
		if (temp1 < 90)
		{
			alert('Session refresh cycle should be greater than the 90 s');
			return;
		}
		...
		if (temp2 < 90)
		{
			alert('Minimum session refresh cycle should be greater than the 90 s');
			return;
		}	
		
		if (temp1 < temp2)
		{
			alert ('The refresh cycles should be greater than the minimum a refresh cycle of the session');	
			return;
		}
		...
		if (temp < 0 || temp > 63)
		{
			alert ('The SIP DSCP priority ranges in 0 ~ 63.');
			return;
		}
		...
		if (temp < 0 || temp > 63)
		{
			alert ('The RTP DSCP priority ranges in 0 ~ 63.');
			return;
		}
		...
		{
			alert('The minimum interval of hang up ranges in 300 ~ 1199 ms.');
			return;
		}	
		if (temp1 >= temp2)
		{
...
<%end if%>
									               ...
									               <tr>
									                  <td>Short Inter Digit Timer(s):</td>
									                  <td>
									               ...
									               <tr>
									                  <td>Long Inter Digit Timer(s):</td>
									                  <td>
									               ...
									               <tr >
									                  <td>Hanging Reminder Tone Timer(s):</td>
									                  <td>
									               ...
									               <tr >
									                  ...
									                  <td>
									                  	<select name="dmtmode" size="1" >
													   	            <option value="0" <%if tcWebApi_get("VoIPDigitMap_Entry", "TMode", "h")	 = "0" then asp_Write("selected") end if %>>Short Timer</option>
													   	            <option value="1" <%if tcWebApi_get("VoIPDigitMap_Entry", "TMode", "h") = "1" then asp_Write("selected") end if %>>Long Timer</option>
													   	            <option value="2" <%if tcWebApi_get("VoIPDigitMap_Entry", "TMode", "h") = "2" then asp_Write("selected") end if %>>T Timer</option>
													   	        </select>
													   	      </td>
									               </tr>
									               <tr >
									                  <td>DTMF Transport Mode :</td>
									                  <td>
									               ...
									               <% if tcWebApi_get("WebCustom_Entry", "isCTPONC9Supported", "h") = "Yes"  then %>
									               <tr >
									                  <td>From To Head URI:</td>
									                  <td>
									                  	<select name="fromtoheadurl" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "FromToHeadURI", "h") = "0" then asp_Write("selected") end if %>>Registrar server</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "FromToHeadURI", "h") = "1" then asp_Write("selected") end if %>>Proxy server</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "FromToHeadURI", "h") = "2" then asp_Write("selected") end if %>>Outbound server</option>
											   	            </select>
											   	          </td>
									               </tr>
									               <% end if %>
                                                                                       <tr >
									                  <td>Options Serice Mode</td>
									                  <td>
									                  	<select name="optionssericemode" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "0" then asp_Write("selected") end if %>>Register server mode</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "1" then asp_Write("selected") end if %>>Proxy server mode</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "2" then asp_Write("selected") end if %>>Outbound mode</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>Fax Control Mode:</td>
									                  <td>
									                  	<select name="faxctrlmode" size="1">
											   	                <option value="other" <%if tcWebApi_get("VoIPAdvanced_Common", "FaxCtrlMode", "h") = "other" then asp_Write("selected") end if %>>auto-negotiation</option>
											   	                <option value="all" <%if tcWebApi_get("VoIPAdvanced_Common", "FaxCtrlMode", "h") = "all" then asp_Write("selected") end if %>>T30 full control</option>
											   	            </select>
											   	          </td>
									               </tr>
									               <tr >
									               ...
									               <tr>
									                      <td>RTP Redundancy Paylod Type:</td>
									                      <td>
									               ...
									               <tr >
									                  ...
									                  <td>
									                  	<select name="DivHotLineType" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "HotLineMode", "h") = "0" then asp_Write("selected") end if %>>Inform user number</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "HotLineMode", "h") = "1" then asp_Write("selected") end if %>>Inform noDial</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "HotLineMode", "h") = "2" then asp_Write("selected") end if %>>Inform activation code</option>
											   	            </select>
											   	          </td>
									               </tr>
									               <tr >
									                  <td>RegResponse Port Enable:</td>
									                  <td>
									                  	<select name="DivIsRegisterWithPort" size="1">
											   	                <option value="Yes" <%if tcWebApi_get("VoIPAdvanced_Common", "RegResponsePortEnable", "h") = "Yes" then asp_Write("selected") end if %>>Without port number</option>
											   	                <option value="No" <%if tcWebApi_get("VoIPAdvanced_Common", "RegResponsePortEnable", "h") = "No" then asp_Write("selected") end if %>>With port number</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>Msg with "user=phone" Enable:</td>
									                  <td>
									                  	<select name="DivIsMsgWithUser" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "MsgWithUserEnable", "h") = "0" then asp_Write("selected") end if %>>No</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "MsgWithUserEnable", "h") = "1" then asp_Write("selected") end if %>>Yes</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>Hotline Activation Number:</td>
									                  <td>
									               ...
									               <tr >
									                  <td>Callwaiting Type:</td>
									                  <td>
									                  	<select name="DivCWType" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "CallWaitType", "h") = "0" then asp_Write("selected") end if %>>Switch directly</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "CallWaitType", "h") = "1" then asp_Write("selected") end if %>>Switch by pressing number key</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>No Reg DialTone Enable:</td>
									                  <td>
									                  	<select name="DivDialtone" size="1">
											   	                <option value="Yes" <%if tcWebApi_get("VoIPAdvanced_Common", "NoRegDialToneEnable", "h") = "Yes" then asp_Write("selected") end if %>>Close DialTone</option>
											   	                <option value="No" <%if tcWebApi_get("VoIPAdvanced_Common", "NoRegDialToneEnable", "h") = "No" then asp_Write("selected") end if %>>Open DialTone</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>Voice Codec Priority Control:</td>
									                  <td>
									                  	<select name="DivCodecSelectFlag" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "VoiceCodecPriorityCtrl", "h") = "0" then asp_Write("selected") end if %>>Dailing priority</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "VoiceCodecPriorityCtrl", "h") = "1" then asp_Write("selected") end if %>>Local priority</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									                  <td>Number Match Mode:</td>
									                  <td>
									                  	<select name="DivDigitMatchMethod" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "NumberMatchMode", "h") = "0" then asp_Write("selected") end if %>>Min Match</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "NumberMatchMode", "h") = "1" then asp_Write("selected") end if %>>Vague Max Match</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "NumberMatchMode", "h") = "2" then asp_Write("selected") end if %>>Max Match</option>
											   	            </select>
									                  </td>
									               </tr>

									               <tr >
									                  <td>ActLocal Supplement Service:</td>
									                  <td>
									               ...
									               <tr >
									                  <td>EndChar Handle Mode</td>
									                  <td>
									                  	<select name="EndCharacterHandleMode" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "EndCharHandleMode", "h") = "0" then asp_Write("selected") end if %>>Abort Mode</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "EndCharHandleMode", "h") = "1" then asp_Write("selected") end if %>>Rule Mode</option>											   	                
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									               		<td>Support SpecChar Transfer:</td>
									                  <td valign="middle">
									               ...
									               <tr >
									               		<td>Comfortable Noise Enable:</td>
									                  <td valign="middle">
									               ...
									               <tr >
									               		<td>Silence Compression Enable:</td>
									                  <td valign="middle">
									               ...
									               <tr >
									               		<td>Automatically Sync Phone Data Switch:</td>
									                  <td valign="middle">
									               ...
									               <tr >
									                  <td>Polarity Reversal Mode：</td>
									                  <td>
									                  	<select name="DivRevPolarityType" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "PolarityReversalMode", "h") = "0" then asp_Write("selected") end if %>>Close</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "PolarityReversalMode", "h") = "1" then asp_Write("selected") end if %>>Open locally</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "PolarityReversalMode", "h") = "2" then asp_Write("selected") end if %>>Server Control </option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									               		<td>Echo Cancellation Enable:</td>
									                  <td valign="middle">
									               ...
									               <tr >
									               		<td>Auto Jitter Buffer Enable:</td>
									                  <td valign="middle">
