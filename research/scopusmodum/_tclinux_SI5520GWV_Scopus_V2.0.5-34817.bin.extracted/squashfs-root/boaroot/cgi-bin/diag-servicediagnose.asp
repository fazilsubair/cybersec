...
<HTML><HEAD><TITLE>Business diagnosis</TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33>
            ...
            value="diagnosis->Business diagnosis" name=Selected_Menu> </FONT></B><SPAN 
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD width=157 bgColor=#ef8218 height=30>
            <P class=Item_L1>VOIP diagnosis</P></TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD width=480>
                  ...
                  <P><STRONG>Line test</STRONG></P>


                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
                    <TBODY>
                    <TR>
			        <TD width="25%" align="center" >Exterior voltage： </TD>
			        <TD width="45%" align=right ><%If tcWebApi_get("VoIPTest_Entry0","LineTestData_vDcDiff","h") <> "N/A" Then tcWebApi_get("VoIPTest_Entry0","LineTestData_vDcDiff","s") end if%>
                        ...
                        &nbsp;</TD>
	                <TD align="center">
                       <INPUT onclick="startLineTest_vDcDiff()" type='button' value=' Apply ' name="btnLineTest"> 
                    </TD> 
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
                    <TBODY>
                    <TR>
			        <TD width="25%" align="center" >Ringing impedance： </TD>
			        <TD width="45%" align=right ><%If tcWebApi_get("VoIPTest_Entry0","LineTestData_rtr","h") <> "N/A" Then tcWebApi_get("VoIPTest_Entry0","LineTestData_rtr","s") end if%>
                        ...
                        &nbsp; </TD>
	                <TD align="center">
                       <INPUT onclick="startLineTest_rtr()" type='button' value=' Apply ' name="btnLineTest"> 
                    </TD> 
                  ...
                  <DIV id=LineTestResult font-size:9px;>
				   <SCRIPT language=javascript>
					if (document.LineTestForm.linetest_TestType.value == "LineVoltageTest")
					{
							...
							if(result != "Complete")
							{
								document.writeln("<B align='center'><font color='#FF0000' size='-1'>Line test failed！</font></B>");
							}
					}

				  </SCRIPT></DIV>
				  <DIV id=WaitMsgLineTest class="hidden">
				  <B><font color="#FF0000" size="-1">Line testing ,please wait...</font></B>
			  	  </DIV>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD>
                  ...
                  <P><STRONG>Simulation dail test</STRONG></P>

                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
                    <TBODY>
                    <TR>
			        <TD width="25%" align="center" >call number ：</TD>
	                ...
	                <TD align="center">
                       <INPUT onclick="startSimulateTest()" type='button' value=' test ' name="btnSimulateTest"> 
                    </TD> 
                    ...
                    <TBODY>
                    <TR>
			        <TD width="20%" align="center" >Line status：</TD>
                    ...
                    <TBODY>
                    <TR>
			        <TD width="20%" align="center" >Simulation result： </TD>
                    ...
                    <TBODY>
                    <TR>
			        <TD width="20%" align="center" >Failing reason： </TD>
                    ...
                    <TBODY>
                    <TR>
			        <TD width="20%" align="center" >Erro code： </TD>
				  ...
				  <B><font color="#FF0000" size="-1">Simulation dial testing ,please wait...</font></B>
			  	  </DIV>
