...
<%end if%>
		...
		if ( weightTotal > 100 )
		{
				alert('WRR weights sum can not exceed 100');
				return false;
		}
	}
	...
	if (bdw!="0"){
	  if (parseInt(bdw) < 8192
	      ...
	      || !isInteger(bdw))
	  {
	      alert('Uplink bandwidth ranges from 8192 to 1000000000, or enter 0 (limited speed).');
	      return false;
	  }
	}
	else
	...
	if(vForm.DiscplineFlag.value == "CAR" && QosSwitch=="Yes")
	{
		...
		{
				alert('The sum of the bandwidth can not be greater than the upstream bandwidth');
				return false;
		}
	}
	vForm.SaveFlag.value = "1";
...
border=0>
        ...
        <TR>
          ...
          <TD width=673 bgColor=#6acafc height=33>
            ...
            value="Network->QoS" name=Selected_Menu> </FONT></B><SPAN 
	...
	<SCRIPT language=JavaScript type=text/javascript>
		...
		function QoSEnableChange()
		{
			with (getElById('ConfigForm'))
			{
				...
				{
					if(!confirm("Whether to disable the Qos template"))
					{
					Enable.checked = true;
				...
				{
					if(!confirm("Whether to enable the Qos template"))
					{
		...
		function PlanChange()
		{
			...
			with (getElById('ConfigForm'))
			{
				if (false == confirm("Whether to replace the scheduling policy?"))
				{
              ...
              <TR>
                ...
                <TD>
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      <TD height=30><B>Enable QoS：</B></TD>
                  ...
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD width=108><B>Uplink Bandwidth:</B></TD>
                  ...
                  <TABLE width="100%" border=0 <% if tcWebApi_get("WebCustom_Entry", "isCTPONCYJXSupported","h") = "Yes" then if tcWebApi_get("DataSpeedLimit_Entry","SpeedLimitModeUP","h") <> "0" then %>style='display:none' <% end if end if %>>
                    <TBODY>
                    <TR>
                      <TD width=310 height=30><B>Scheduling Policies:</B></TD>
                  ...
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR id=EnableForce>
                      <TD width=108 height=30><B>Enable Force Weight</B></TD>
                    ...
                    <TR>
                      <TD width=130 height=30><B>Enable DSCP/TC Mark：</B></TD>
                      <TD width=90><INPUT id=EnableDSCPMark type=checkbox 
                         value=0  name="EnableDSCPMark" <%if tcWebApi_get("QoS_Common","EnableDSCPMark","h") = "Yes" then asp_Write("checked") end if%>>
                                  ...
                                  <TD width=132><B>Enable 802.1P Mark：</B></TD>
                      <TD width=130><SELECT id=Enable8021P size=1 name="Enable8021P"> 
                          <OPTION value="0" <%if tcWebApi_get("QoS_Common","En8021PRemark","h") = "0" then asp_Write("selected") end if%>>Zero Tagged</OPTION> 
						  <OPTION value="1" <%if tcWebApi_get("QoS_Common","En8021PRemark","h") = "1" then asp_Write("selected") end if%>>Transparent</OPTION> 
						  <OPTION value="2" <%if tcWebApi_get("QoS_Common","En8021PRemark","h") = "2" then asp_Write("selected") end if%>>Re-mark</OPTION>
						  </SELECT></TD></TR></TBODY></TABLE></DIV>
                  <DIV id=COMVlanBtn>
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD width=92><INPUT id=COMVlanCls onclick="VlanSubmit('/cgi-bin/qos-comvlan.asp')" type=button value=Set VLAN value name=COMVlanCls></TD></TR></TBODY></TABLE></DIV>
                  <DIV id=QueueEdit>
                  <DIV id=PQEdit>
                  <TABLE width=360 border=1>
                    <TBODY>
                    <TR>
                      <TD class=table_title align=middle width=100>Queue</TD>
                      <TD class=table_title align=middle>Priority</TD>
                      <TD class=table_title align=middle>Enable</TD></TR>
                    <TR>
                  ...
                  <TABLE width=420 border=1>
                    ...
                    <TR>
                      <TD class=table_title align=middle width=100>Queue</TD>
                      <TD class=table_title align=middle>Weight</TD>
                      <TD class=table_title align=middle>Enable</TD></TR>
                    <TR>
                      <TD align=middle>Q1</TD>
                  ...
                  <TABLE width=420 border=1>
                    ...
                    <TR>
                      <TD class=table_title align=middle width=100>Queue</TD>
                      <TD class=table_title align=middle>Bandwidth(kbps)</TD>
                      <TD class=table_title align=middle>Enable</TD></TR>
                    <TR>
                      <TD align=middle>Q1</TD>
                  ...
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD width=92><INPUT id=AddCls onclick="VlanSubmit('/cgi-bin/qos-clsedit.asp')" type=button value="Edit Classification" name=AddCls></TD></TR></TBODY></TABLE></DIV>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
      ...
      <TABLE id=table7 height=35 cellSpacing=0 cellPadding=0 width=1008 
        ...
        <TR>
          ...
          <TD width=393 bgColor=#ffffff>
            ...
            <P align=center><INPUT type=button value="Apply" id=btnOK 

            onclick="btnSave()" height=23 

            width=80 border=0>&nbsp;&nbsp;<INPUT type=button value="Cancel" id=btnCancel 

            height=23 onclick="RefreshPage()" width=80 border=0></P></TD>
