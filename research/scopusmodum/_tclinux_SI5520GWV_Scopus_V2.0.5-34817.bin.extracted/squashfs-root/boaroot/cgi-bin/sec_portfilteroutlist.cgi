...
bgcolor=\"#FFFFFF\"><tr><TD class=table_title align=middle width=\"10%\"><STRONG>Filter Name</STRONG></TD><td width=\"10%\" align=center
...
class=\"table_title\"><strong>Destination Port</strong></td><td width=\"10%\" align=center
class=\"table_title\"><strong>Enable</strong></td><td width=\"8%\" align=center
...
do
	...
	then
		...
		then
			...
			width=\"10%\">$Activate</td><td width=\"8%\"><input type=\"checkbox\" name=\"rmlout\" onclick=\"doDel($iEntry);\" value=\"$iEntry\"></td></tr>"
		fi
	elif [ $k = 11 ]
	then
		srcIPEndAddr=$LINE
