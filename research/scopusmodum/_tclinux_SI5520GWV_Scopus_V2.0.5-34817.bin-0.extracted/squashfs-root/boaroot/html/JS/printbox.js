...
{	
	...
	PrintBuf =  PrintBuf + '&nbsp;<INPUT type=\"button\" class="btns"  value = \"Delete\" onclick = \"webClickRemove();\" id=\"button\" name=\"button\">';
...
//style=\"word-wrap:break-word\"
	...
	PrintBuf += ('</TABLE>');
    PrintBuf =  PrintBuf + '<BR><table><tr><td><INPUT type=\"button\"  class="btns"  value = \"Add\" onclick = \"webClickAdd('+'\''+strDomainName+'\''+','+'\''+strUrl+'\''+');\">';
	PrintBuf =  PrintBuf + '&nbsp;<INPUT type=\"button\" class="btns"  value = \"Delete\" onclick = \"webClickRemove();\"></td></tr></table>';
