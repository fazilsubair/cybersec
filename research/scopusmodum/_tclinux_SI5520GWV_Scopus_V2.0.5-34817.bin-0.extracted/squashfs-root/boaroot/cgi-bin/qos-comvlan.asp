...
{
alert('There are currently no WAN interface, add a new one and then perform RIP configuration!');
return false;
}
...
<tr>
<td width="157" bgcolor="#dff5ff" height="30"><p class="Item_L1">QoS</p></td>
<td width="7" bgcolor="#ffffff">&nbsp;</td>
<td width="674">&nbsp;</td>
<td width="170" rowspan="9" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="20" height='100%'>
<tr>
...
<table border="1" cellpadding="3" cellspacing="0" width="400" bordercolor=#e3e3e3>
<tr align='center'>
<td class="table_title">Interface</td>
...
<br>
<input type='button' onClick='btnRtturnQoS()' value='Return to Queue page editor'>
</p>
</td>
<td width="10">&nbsp;</td>
</tr>
...
<tr>
<td width="157" height="100%" valign="top" bgcolor="#dff5ff"></td>
<TD width="7" height="15" bgColor="#ffffff" border="0"></TD>
<td></td>
</tr>
</table>
...
<p align="center"><INPUT type=button value="Apply" width="80" height="23" border="0" id="btnOK" onClick=BtnSave()>&nbsp;&nbsp;<INPUT type=button value="Cancel" width="80" height="23" border="0" id="btnCancel" onclick="RefreshPage()"> </td>
<td width="169">&nbsp;</td>
</tr>
</table>
</td>
