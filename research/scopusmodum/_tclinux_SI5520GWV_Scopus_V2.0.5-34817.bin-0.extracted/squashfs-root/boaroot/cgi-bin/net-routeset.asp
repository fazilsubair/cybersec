...
<HTML><HEAD><TITLE>Routing Configuration</TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=673 bgColor=#6acafc height=33>
            ...
            value="Network->Routing" name=Selected_Menu> </FONT></B><SPAN 
...
MakeMenu(getElById ('Selected_Menu').value);
      ...
      <TABLE id=table3 height=15 cellSpacing=0 cellPadding=0 width=1008 
        border=0><TBODY>
        <TR>
          <TD height=15 width=154 border=0 bgColor=#dff5ff></TD>
...
function CheckRoutesActives()
{
	...
	vcurLinks[nCurTemp++] = new Array("cgi-bin/net-routeadd.asp","", "InternetGatewayDevice.Layer3Forwarding.Forwarding", "Destination address", "Gateway", "Subnet mask", "Interface");
...
new Array("cgi-bin/net-routeadd.asp","", "InternetGatewayDevice.Layer3Forwarding.Forwarding", "Destination address", "Gateway", "Subnet mask", "Interface"),
...
{
alert('Currently no WAN interface, add new WAN interface and then perform RIP configuration!');
return false;
}
return true;
}
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0 id="mainTableSet"  width="1008">
        ...
        <TR>
          <TD width=157 bgColor=#dff5ff height=30>
            <P class=Item_L1>Static Routing</P></TD>
...
border=0 height='100%'>
              ...
              <TR>
                <TD valign='top'><A 
                  href="/cgi-bin/help_content.asp#Routing" 
                ...
                <TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 bordercolor=#e3e3e3>
                    ...
                    <TR>
                      <TD>
                        <SCRIPT language=JavaScript type=text/javascript>
printInstNoEditBox('StaticRoute',650);
</SCRIPT>
        ...
        <TR id="DynaRouteInfo1">
          <TD width=157 bgColor=#dff5ff height=30>
            <P class=Item_L1>Dynamic routing</P></TD>
          <TD width=7 bgColor=#ffffff>&nbsp;</TD>
          <TD width=674>&nbsp;</TD></TR>
        <TR>
          <TD vAlign=top width=157 bgColor=#dff5ff height=10></TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 bordercolor=#e3e3e3>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width=650 border=1 bordercolor=#e3e3e3>
                    <TBODY>
                    <TR align=middle>
                              <TD class=table_title>Interface
	...
	for (var i = 0; i < nEntryNum; i++)
	{
			...
			if(document.RipCfg.curSet_Flag.value == vEntryIndex[i])
				document.RipCfg.sel_Interface.selectedIndex= i;
                      ...
                      <TD class=table_title>Operating</TD>
                      <TD class=table_title>Version</TD></TR>
                    <TR align=middle>
...
//ChangeInterface(obj);
					...
					<INPUT onclick="btnRipSave()" type=button value=Save / Apply> 
                  </P></TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
        ...
        <TR>
          ...
          <TD width=157 bgColor=#dff5ff height=30>
            <P class=Item_L1>IPv6 Static Routing</P></TD>
          <TD width=7 bgColor=#ffffff>&nbsp;</TD>
        <% else %>
              ...
              <TR>
                ...
                <TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD>
                        <TABLE cellSpacing=1 cellPadding=3 width=650 border=1 bordercolor=#e3e3e3>
                          <TBODY>
                          <TR align=middle>
                            <TD class=table_title align=middle>Destination address</TD>
                            <TD class=table_title align=middle>Gateway</TD>
                            <TD class=table_title align=middle>Interface</TD>
                            <TD class=table_title align=middle>Enable</TD>
                            <TD class=table_title align=middle>Delete</TD></TR>
                          <SCRIPT language=JavaScript type=text/javascript>
...
document.write('</TR>');
                                ...
                                <BR>
                                <LEFT><INPUT id=btnAdd onclick="AddStaticRt()" type=button value=Add> 
      ...
      <TABLE id=table7 height=35 cellSpacing=0 cellPadding=0 width=1008 
        ...
        <TR>
          ...
          <TD width=393 bgColor=#ffffff>
            <P align=center><INPUT type=button value="Apply" id=btnOK onclick="" height=23 width=80 border=0>&nbsp;&nbsp;<INPUT type=button value="Cancel" 
