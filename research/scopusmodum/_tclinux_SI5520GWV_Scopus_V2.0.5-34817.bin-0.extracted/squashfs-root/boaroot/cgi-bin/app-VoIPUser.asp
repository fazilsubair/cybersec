    ...
    <HEAD>
        ...
        <SCRIPT language=JavaScript type=text/javascript>
            ...
            function LoadFrame() {
                ...
                var ProfileBody_exp = 'Parameter format "number = value", seperated by semicolon. Serial number starts from 1, must be continuous';
                var Software_exp = 'Parameter format "number = value", seperated by semicolon';
            ...
            function CheckForm1() {
                ...
                if (ProfileBody_ex.value.length > 8194) {
                    alert("Control point length must be less than 8194 characters");
                    return false;
                }

                if (SoftwarePara_ex.value.length > 8194) {
                    alert("Software parameter length must be less than 8194 characters");
                    return false;
                }
            ...
            function CheckForm(type) {
                ...
                for (var i = 1; i < 5; i++) {
                    if (getValue('Priority' + i) > 100) {
                        alert("Priority is invalid, please reset it(range: 1-100)");
                        return false;
                    }
                }
                for (var i = 1; i < 5; i++) {
                ...
                if (parseInt(RingDCVoltageOverlapped) < 0 || RingDCVoltageOverlapped > 25) {
                    alert('Invalid dc voltage setting, please reset it(range 0-25)');
                    return false;
                }

                if (parseInt(UserDefineRingVoltage) < 0 || parseInt(UserDefineRingVoltage) > 74) {
                    alert('Invalid custom ring voltage, please reset it(range of 0-74)');
                    return false;
                }

                if (parseInt(HookFlashDownTime) < 0 || parseInt(HookFlashDownTime) > 1400) {
                    alert('Invalid pat fork floor, please reset it(range 0-1400)');
                    return false;
                }

                if (parseInt(HookFlashUpTime) < 0 || parseInt(HookFlashUpTime) > 1400) {
                    alert('Invalid pat fork cap, please reset it(range 0-1400)');
                    return false;
                }

                if (parseInt(OnhookConfirmTime) < 0 || parseInt(OnhookConfirmTime) > 1400) {
                    alert('Invalid hang up to confirm time, please reset it(range of 0-1400)');
                    return false;
                }
                ...
                if (((parseInt(HookFlashUpTime) < parseInt(HookFlashDownTime)) || (parseInt(OnhookConfirmTime) < parseInt(HookFlashUpTime))) && (parseInt(OnhookConfirmTime) != 0)) {
                    alert('The pat fork cap must be greater than floor, hang up to confirm time must be greater than the pat fork cap');
                    return false;
                }

                if (parseInt(Current) < 16 || parseInt(Current) > 49) {
                    alert('Invalid feed current, please reset it(range 16-49)');
                    return false;
                }

                if (parseInt(FskTime) < 0 || parseInt(FskTime) > 2000) {
                    alert('Invalid sending FSK interval, please reset it(range of 0-2000)');
                    return false;
                }
...
<% end if %> 
                        ...
                        <TABLE id=table2 height=100 cellSpacing=0 cellPadding=0 width=1008 border=0>
                            <TBODY>
                                <TR>
                                    <TD class=LocationDisplay id=LocationDisplay align=middle width=157 bgColor=#ef8218
                                    rowSpan=3>
                                    </TD>
                                            ...
                                            <FONT face="Arial" color=#ffffff>
                                                <B>
                                                    <FONT face="Arial" color=#ffffff size=6>
                                                        <INPUT id=Selected_Menu type=hidden value="Application->VoIP" name=Selected_Menu>
                                                    </FONT>
                                                </B>
                        ...
                        <TABLE id=table3 height=15 cellSpacing=0 cellPadding=0 width=1008 border=0>
                            <TBODY>
                                <TR>
                                    ...
                                    <TD>
                                        <IMG height=15 src="/img/panel2.gif" width=844 border=0>
                                    </TD>
                                </TR>
                            </TBODY>
                        </TABLE>
                                    ...
                                    <TD vAlign=top class=table1_help background=/img/panel4.gif rowSpan=8>
                                        <TABLE cellSpacing=0 cellPadding=20 width="100%" border=0 height='100%'>
                                            <TBODY>
                                                <TR>
                                                    <TD valign='top'>
                                                        <A href="/cgi-bin/help_content.asp#VoIP" target=_blank>
                                                            ...
                                                            <TBODY>
                                                                <TR>
                                                                    ...
                                                                    <TD class=table1_submit width="80%" align=left>
                                                                        <INPUT id=btnApplySipServer2 class=submit onclick=Submit2() value=" Apply "
                                                                        type=button name=btnApplySipServer2>
                                                                        <INPUT id=cancelValue2 class=submit onclick=CancelConfig2(); value=" Cancel "
                                                                    ...
                                                                    <TBODY>
                                                                        ...
                                                                        <TR>
                                                                            <TD class=table1_right colSpan=4 style='text-align:right' >
                                                                                <SELECT id=Impedance >
                                                                                    <OPTION value=0>
                                                                                        Chinese side machine(200+680|| 100nf)
                                                                                    </OPTION>
                                                                                    <OPTION value=1>
                                                                                        Chinese users machine(200+560|| 100nf)
                                                                                    </OPTION>
                                                                                    <OPTION selected value=2>
                                                                                        600Ω interface
                                                                                    </OPTION>
                                                                                    <OPTION value=3>
                                                                                        Russian‘s interface(150+510|| 47nf)
                                                                                    </OPTION>
                                                                                    <OPTION value=4>
                                                                                        (220+820|| 115nf )
                                                                                    </OPTION>
                                                                                    ...
                                                                                    <OPTION value=14>
                                                                                        Gm Europe(Zin= 270+750|| 150nf)
                                                                                    </OPTION>
                                                                                    <OPTION value=15>
                                                                                        New Zealand(Zin= 370+620|| 310nf )
                                                                                    </OPTION>
                                                                                </SELECT>
                                                                            </TD>
                                                                        </TR>
                                                                ...
                                                                <TBODY>
                                                                    <TR>
                                                                        ...
                                                                        <TD style="HEIGHT: 50px" class=table1_submit colSpan=3>
                                                                            <INPUT id=btnApplyVoipUser3 class=submit onclick=Submit(); value=" Apply "
                                                                            type=button name=btnApplyVoipUser3>
                                                                            <INPUT id=cancelValue3 class=submit onclick=CancelConfig(); value=" Cancel "
                        ...
                        <TABLE id=table7 height=35 cellSpacing=0 cellPadding=0 width=1008 border=0>
                            <TBODY>
                                <TR>
                                    ...
                                    <TD width=169 background=/img/panel4.gif>
                                        &nbsp;
                                    </TD>
                                </TR>
                            </TBODY>
