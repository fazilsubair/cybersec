...
if [ -f "$FILE" ];
then
    echo "<center><b><font size=5>Upgrade terminal Being version, do not under power.</font></b></center><br /><br />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<font color=red>Prompt</font>:<br />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspITMS platform is remotely upgrade the device, and the system automatically configure the service to start after (within 10 minutes), please note the following:<br />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1.during the upgrade, do not power down.<br />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2.During the upgrade process, do not plug the fiber.<br />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp3.During the upgrade, do not close the page.<br />"

else
	echo "<center><b><font size=5>Terminal upgrade was successful, you can use normal business, thank you for your patience.</font></b></center>"      
fi
...
{ 
  ...
  if (eraseFlashBeginFlag == 1){
      ...
      if ((onloadCount > (onloadCountWhenEraseFlash+connectWanCount+biasOfBrowser)) && (countAfterErase > (eraseFlashCount+rebootCount))){
  		  msg=\"<center><b><font size=5>Terminal upgrade was successful, you can use normal business, thank you for your patience.</font></b></center>\";
  	  }
  }
