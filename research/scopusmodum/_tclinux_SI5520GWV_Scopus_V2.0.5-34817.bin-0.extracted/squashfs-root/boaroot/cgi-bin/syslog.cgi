...
charset=UTF-8\"><LINK href=\"/JS/stylemain.css\" type=\"text/css\"
...
echo -e "<tr rowspan=\"2\"><td>Display Level:<select name=\"levels\" onChange=\"levelChange(this)\">
<option value=\"0\""
	case "$loglevel" in
	"0" )
	echo -e "selected";;
	esac
echo -e ">Emergency</option>"
...
echo -e ">Warning</option>"
echo -e "<option value=\"5\""
	case "$loglevel" in
	"5" )
	echo -e "selected";;
	esac
echo -e ">Notice</option>"
echo -e "<option value=\"6\""
	case "$loglevel" in
	"6" )
	echo -e "selected";;
	esac
echo -e ">Informal</option>"
echo -e "<option value=\"7\""
	case "$loglevel" in
	"7" )
	echo -e "selected";;
	esac
echo -e ">Debugging</option></select></td></tr>"

echo -e "<tr rowspan=\"1\"><td>&nbsp;</td></tr>"

echo -e "<TR><TD>TX Optical Power :<SCRIPT language=JavaScript type=text/javascript>document.write(SendPower);</SCRIPT>dBm&nbsp;</TD></TR>"
echo -e "<TR><TD>RX Optical Power :<SCRIPT language=JavaScript type=text/javascript>document.write(RecvPower);</SCRIPT>dBm&nbsp;</TD></TR>"

echo -e "<tr><td><TEXTAREA NAME=\"AlphaLogDisplay\" STYLE=\"WIDTH:645px;HEIGHT:521px;\" WRAP=\"ON\" EDIT=\"OFF\" READONLY>"
