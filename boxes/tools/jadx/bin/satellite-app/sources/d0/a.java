...
public final class a extends C0170t {
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f2033e == null) {
            int w2 = B.a.w(this, com.satellite.bigbang.R.attr.colorControlActivated);
            int w3 = B.a.w(this, com.satellite.bigbang.R.attr.colorSurface);
            int w4 = B.a.w(this, com.satellite.bigbang.R.attr.colorOnSurface);
