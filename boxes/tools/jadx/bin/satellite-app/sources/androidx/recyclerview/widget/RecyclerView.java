...
public class RecyclerView extends ViewGroup implements InterfaceC0010k {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.satellite.bigbang.R.attr.recyclerViewStyle);
    }
    ...
    */
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (obtainStyledAttributes.getBoolean(3, false)) {
            ...
            c2 = 2;
            z2 = 1;
            new C0040p(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(com.satellite.bigbang.R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(com.satellite.bigbang.R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(com.satellite.bigbang.R.dimen.fastscroll_margin));
        } else {
            i3 = 4;
            c2 = 2;
            z2 = 1;
