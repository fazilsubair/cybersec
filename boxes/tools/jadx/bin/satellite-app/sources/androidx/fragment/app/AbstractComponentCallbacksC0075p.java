...
public abstract class AbstractComponentCallbacksC0075p implements ComponentCallbacks, View.OnCreateContextMenuListener, androidx.lifecycle.o, androidx.lifecycle.E, androidx.savedstate.e {
    ...
    public void z(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (r2 == null) {
            ...
            this.f1383N.e();
            this.f1374E.setTag(R.id.view_tree_lifecycle_owner, this.f1383N);
            this.f1374E.setTag(R.id.view_tree_view_model_store_owner, this.f1383N);
            this.f1374E.setTag(R.id.view_tree_saved_state_registry_owner, this.f1383N);
