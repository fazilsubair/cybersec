...
public class ActionBarOverlayLayout extends ViewGroup implements InterfaceC0142e0, InterfaceC0012m, InterfaceC0013n {
    ...
    public static final int[] f841B = {R.attr.actionBarSize, android.R.attr.windowContentOverlay};
    ...
    public final void k() {
        ...
        if (this.f845c == null) {
            this.f845c = (ContentFrameLayout) findViewById(R.id.action_bar_activity_content);
            this.f846d = (ActionBarContainer) findViewById(R.id.action_bar_container);
