...
public class ListMenuItemView extends LinearLayout implements C, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        ...
        C0097c t2 = C0097c.t(getContext(), attributeSet, AbstractC0092a.f2023r, R.attr.listMenuViewStyle, 0);
        this.f804j = t2.g(5);
        this.f805k = t2.m(1, -1);
    ...
    */
    ...
    public final void onFinishInflate() {
        ...
        this.f800f = (TextView) findViewById(R.id.shortcut);
        ImageView imageView = (ImageView) findViewById(R.id.submenuarrow);
        this.f801g = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.f808n);
        }
        this.f802h = (ImageView) findViewById(R.id.group_divider);
        this.f803i = (LinearLayout) findViewById(R.id.content);
    }
