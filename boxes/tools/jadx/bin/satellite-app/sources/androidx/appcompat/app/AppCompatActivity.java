...
public class AppCompatActivity extends FragmentActivity implements j {
    ...
    public final void attachBaseContext(Context context) {
        ...
        if (v.f2159b0) {
            ...
            C0105e c0105e = new C0105e(context, com.satellite.bigbang.R.style.Theme_AppCompat_Empty);
            c0105e.a(o2);
            try {
    ...
    public final void k() {
        getWindow().getDecorView().setTag(com.satellite.bigbang.R.id.view_tree_lifecycle_owner, this);
        getWindow().getDecorView().setTag(com.satellite.bigbang.R.id.view_tree_view_model_store_owner, this);
        getWindow().getDecorView().setTag(com.satellite.bigbang.R.id.view_tree_saved_state_registry_owner, this);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (vVar.f2209z && vVar.f2203t) {
            ...
            E e2 = vVar.f2191h;
            if (e2 != null) {
                e2.o0(e2.f2050c.getResources().getBoolean(com.satellite.bigbang.R.bool.abc_action_bar_embed_tabs));
            }
        }
        C0178x a2 = C0178x.a();
