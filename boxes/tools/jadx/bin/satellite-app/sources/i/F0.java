        ...
        switch (i10) {
            case 0:
                ...
                if (view2.getWidth() > 1) {
                    ...
                    int dimensionPixelSize = searchView.f908M ? resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_icon_width) : 0;
