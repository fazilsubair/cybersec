    ...
    public final Drawable b(Context context, int i2) {
        ...
        if (this.f2959e != null) {
            if (i2 == R.drawable.abc_cab_background_top_material) {
                ...
                layerDrawable = C0176w.c(this, context, R.dimen.abc_star_big);
            } else if (i2 == R.drawable.abc_ratingbar_indicator_material) {
                layerDrawable = C0176w.c(this, context, R.dimen.abc_star_medium);
            } else if (i2 == R.drawable.abc_ratingbar_small_material) {
                layerDrawable = C0176w.c(this, context, R.dimen.abc_star_small);
            }
        }
