...
public final class v extends k implements h.m, LayoutInflater.Factory2 {
            ...
            if (oVar == null || uVar.f2155o) {
                if (oVar == null) {
                    ...
                    if ((i2 == 0 || i2 == 108) && this.f2194k != null) {
                        ...
                        theme2.resolveAttribute(com.satellite.bigbang.R.attr.actionBarTheme, typedValue, true);
                        if (typedValue.resourceId != 0) {
                            theme = context.getResources().newTheme();
                            theme.setTo(theme2);
                            theme.applyStyle(typedValue.resourceId, true);
                            theme.resolveAttribute(com.satellite.bigbang.R.attr.actionBarWidgetTheme, typedValue, true);
                        } else {
                            theme2.resolveAttribute(com.satellite.bigbang.R.attr.actionBarWidgetTheme, typedValue, true);
                            theme = null;
                        }
                        if (typedValue.resourceId != 0) {
                            if (theme == null) {
            ...
            if (this.f2198o.isShown()) {
                ...
                if (r5 && view3.getVisibility() != 0) {
                    ...
                    if ((AbstractC0023y.g(view4) & 8192) != 0) {
                        ...
                        a2 = w.d.a(context, com.satellite.bigbang.R.color.abc_decor_view_status_guard_light);
                    } else {
                        Object obj2 = w.e.f3731a;
                        a2 = w.d.a(context, com.satellite.bigbang.R.color.abc_decor_view_status_guard);
                    }
    ...
    */
    ...
    public final void r() {
        ...
        int i3 = 2;
        if (this.f2164D) {
            viewGroup = this.f2162B ? (ViewGroup) from.inflate(com.satellite.bigbang.R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(com.satellite.bigbang.R.layout.abc_screen_simple, (ViewGroup) null);
        } else if (this.f2163C) {
            viewGroup = (ViewGroup) from.inflate(com.satellite.bigbang.R.layout.abc_dialog_title_material, (ViewGroup) null);
            this.f2161A = false;
            this.f2209z = false;
        } else if (this.f2209z) {
            TypedValue typedValue = new TypedValue();
            context.getTheme().resolveAttribute(com.satellite.bigbang.R.attr.actionBarTheme, typedValue, true);
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new C0105e(context, typedValue.resourceId) : context).inflate(com.satellite.bigbang.R.layout.abc_screen_toolbar, (ViewGroup) null);
            InterfaceC0142e0 interfaceC0142e0 = (InterfaceC0142e0) viewGroup.findViewById(com.satellite.bigbang.R.id.decor_content_parent);
        ...
        if (this.f2194k == null) {
            this.f2205v = (TextView) viewGroup.findViewById(com.satellite.bigbang.R.id.title);
        }
        Method method = b1.f2779a;
        try {
        ...
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(com.satellite.bigbang.R.id.action_bar_activity_content);
