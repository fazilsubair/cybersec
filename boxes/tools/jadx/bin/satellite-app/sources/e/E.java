...
public final class E extends B.a implements InterfaceC0143f {
    ...
    public final Context l0() {
        if (this.f2051d == null) {
            ...
            this.f2050c.getTheme().resolveAttribute(com.satellite.bigbang.R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public final void m0(View view) {
        ...
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(com.satellite.bigbang.R.id.decor_content_parent);
        this.f2052e = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        KeyEvent.Callback findViewById = view.findViewById(com.satellite.bigbang.R.id.action_bar);
        ...
        this.f2054g = wrapper;
        this.f2055h = (ActionBarContextView) view.findViewById(com.satellite.bigbang.R.id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(com.satellite.bigbang.R.id.action_bar_container);
        ...
        o0(context.getResources().getBoolean(com.satellite.bigbang.R.bool.abc_action_bar_embed_tabs));
        TypedArray obtainStyledAttributes = this.f2050c.obtainStyledAttributes(null, AbstractC0092a.f2006a, com.satellite.bigbang.R.attr.actionBarStyle, 0);
