...
public final class i extends Dialog implements DialogInterface, j {
    ...
    */
    ...
    public final void addContentView(View view, ViewGroup.LayoutParams layoutParams) {
        v vVar = (v) e();
        vVar.r();
        ((ViewGroup) vVar.f2204u.findViewById(android.R.id.content)).addView(view, layoutParams);
    ...
    public final void setContentView(View view) {
        v vVar = (v) e();
        vVar.r();
        ViewGroup viewGroup = (ViewGroup) vVar.f2204u.findViewById(android.R.id.content);
    ...
    public final void onCreate(Bundle bundle) {
        ...
        TypedValue typedValue = new TypedValue();
        hVar.f2095a.getTheme().resolveAttribute(R.attr.alertDialogCenterButtons, typedValue, true);
        ...
        if (hVar.f2109o != null) {
            ...
            hVar.f2106l = (ImageView) window.findViewById(android.R.id.icon);
        ...
        if (i4 != 0) {
            ...
            View findViewById9 = hVar.f2099e != null ? b2.findViewById(R.id.titleDividerNoCustom) : null;
