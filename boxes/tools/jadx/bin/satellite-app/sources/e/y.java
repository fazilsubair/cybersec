...
public class y {
    ...
    public C0168s b(Context context, AttributeSet attributeSet) {
        return new C0168s(context, attributeSet, com.satellite.bigbang.R.attr.buttonStyle);
    }

    public C0170t c(Context context, AttributeSet attributeSet) {
        return new C0170t(context, attributeSet, com.satellite.bigbang.R.attr.checkboxStyle);
    }
