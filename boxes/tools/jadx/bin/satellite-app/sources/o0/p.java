...
public final class p extends C0165q {
    ...
    public p(Context context, AttributeSet attributeSet) {
        super(p0.a.a(context, attributeSet, R.attr.autoCompleteTextViewStyle, 0), attributeSet);
        this.f3425g = new Rect();
        Context context2 = getContext();
        TypedArray j2 = h0.k.j(context2, attributeSet, X.a.f689j, R.attr.autoCompleteTextViewStyle, R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (j2.hasValue(0) && j2.getInt(0, 0) == 0) {
            setKeyListener(null);
        }
        this.f3424f = (AccessibilityManager) context2.getSystemService("accessibility");
        C0171t0 c0171t0 = new C0171t0(context2, null, R.attr.listPopupWindowStyle, 0);
        this.f3423e = c0171t0;
        c0171t0.f2921x = true;
