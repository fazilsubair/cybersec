...
public final class G extends x implements PopupWindow.OnDismissListener, View.OnKeyListener {
    ...
    public G(int i2, int i3, Context context, View view, o oVar, boolean z2) {
        ...
        this.f2356c = oVar;
        this.f2358e = z2;
        this.f2357d = new l(oVar, LayoutInflater.from(context), z2, R.layout.abc_popup_menu_item_layout);
        this.f2360g = i2;
        this.f2361h = i3;
        Resources resources = context.getResources();
        this.f2359f = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
        this.f2366m = view;
    ...
    public final void i() {
        ...
        if (this.f2374u) {
            o oVar = this.f2356c;
            if (oVar.f2462m != null) {
                FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(context).inflate(R.layout.abc_popup_menu_header_item_layout, (ViewGroup) c0150i0, false);
