...
public final class t extends G {
    ...
    public t(ContextThemeWrapper contextThemeWrapper, c cVar, z zVar) {
        ...
        int dimensionPixelSize2 = n.J(contextThemeWrapper, android.R.attr.windowFullscreen) ? contextThemeWrapper.getResources().getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) : 0;
    ...
    public final void c(f0 f0Var, int i2) {
        ...
        MaterialCalendarGridView materialCalendarGridView = (MaterialCalendarGridView) sVar.f1846u.findViewById(R.id.month_grid);
