...
public final class n<S> extends DialogInterfaceOnCancelListenerC0071l {
    ...
    public static boolean J(Context context, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(h0.k.m(context, R.attr.materialCalendarStyle, l.class.getCanonicalName()), new int[]{i2});
    ...
    public final Dialog G() {
        ...
        this.f1828p0 = J(context, android.R.attr.windowFullscreen);
        int m2 = h0.k.m(context, R.attr.colorSurface, n.class.getCanonicalName());
        m0.h hVar = new m0.h(context, null, R.attr.materialCalendarStyle, R.style.Widget_MaterialComponents_MaterialCalendar);
        this.s0 = hVar;
        hVar.i(context);
    ...
    public final View r(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        View inflate = layoutInflater.inflate(this.f1828p0 ? R.layout.mtrl_picker_fullscreen : R.layout.mtrl_picker_dialog, viewGroup);
        ...
        stateListDrawable.addState(new int[]{android.R.attr.state_checked}, B.a.A(context, R.drawable.material_ic_calendar_black_24dp));
        ...
        this.r0.setContentDescription(checkableImageButton2.f1857d ? checkableImageButton2.getContext().getString(R.string.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton2.getContext().getString(R.string.mtrl_picker_toggle_to_text_input_mode));
