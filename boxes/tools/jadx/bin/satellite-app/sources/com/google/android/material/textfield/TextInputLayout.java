    ...
    */
    ...
    private void setPlaceholderTextEnabled(boolean z2) {
        ...
        if (z2) {
            ...
            this.f1933r = x2;
            x2.setId(R.id.textinput_placeholder);
            i iVar = new i();
            iVar.f612x = 3;
            iVar.f634c = 87L;
    ...
    public final void b() {
        ...
        int i5 = this.f1892P;
        if (this.f1886J == 1) {
            TypedValue l2 = k.l(getContext(), R.attr.colorSurface);
    ...
    */
    ...
    public final void h() {
        ...
        if (this.f1886J == 1) {
            if (getContext().getResources().getConfiguration().fontScale >= 2.0f) {
                this.f1887K = getResources().getDimensionPixelSize(R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (k.i(getContext())) {
                this.f1887K = getResources().getDimensionPixelSize(R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
        if (this.f1908e != null && this.f1886J == 1) {
            if (getContext().getResources().getConfiguration().fontScale >= 2.0f) {
                ...
                AbstractC0024z.k(editText3, AbstractC0024z.f(editText3), getResources().getDimensionPixelSize(R.dimen.material_filled_edittext_font_2_0_padding_top), AbstractC0024z.e(this.f1908e), getResources().getDimensionPixelSize(R.dimen.material_filled_edittext_font_2_0_padding_bottom));
            } else if (k.i(getContext())) {
                EditText editText4 = this.f1908e;
                WeakHashMap weakHashMap3 = O.f58a;
                AbstractC0024z.k(editText4, AbstractC0024z.f(editText4), getResources().getDimensionPixelSize(R.dimen.material_filled_edittext_font_1_3_padding_top), AbstractC0024z.e(this.f1908e), getResources().getDimensionPixelSize(R.dimen.material_filled_edittext_font_1_3_padding_bottom));
            }
        }
        if (this.f1886J != 0) {
            r();
    ...
    public final void n(int i2) {
        ...
        if (i3 == -1) {
            ...
            this.f1921l = i2 > i3;
            Context context = getContext();
            this.f1923m.setContentDescription(context.getString(this.f1921l ? R.string.character_counter_overflowed_content_description : R.string.character_counter_content_description, Integer.valueOf(i2), Integer.valueOf(this.f1920k)));
            if (z2 != this.f1921l) {
                o();
            }
            ...
            X x2 = this.f1923m;
            String string = getContext().getString(R.string.character_counter_pattern, Integer.valueOf(i2), Integer.valueOf(this.f1920k));
            if (string == null) {
                bVar.getClass();
            } else {
    ...
    */
    ...
    public void setCounterEnabled(boolean z2) {
        if (this.f1918j != z2) {
            ...
            if (z2) {
                X x2 = new X(getContext(), null);
                this.f1923m = x2;
                x2.setId(R.id.textinput_counter);
                ...
                ((ViewGroup.MarginLayoutParams) this.f1923m.getLayoutParams()).setMarginStart(getResources().getDimensionPixelOffset(R.dimen.mtrl_textinput_counter_margin_start));
                o();
                if (this.f1923m != null) {
                    EditText editText = this.f1908e;
    ...
    public void setHelperTextEnabled(boolean z2) {
        ...
        if (z2) {
            X x2 = new X(oVar.f3402a, null);
            oVar.f3419r = x2;
            x2.setId(R.id.textinput_helper_text);
