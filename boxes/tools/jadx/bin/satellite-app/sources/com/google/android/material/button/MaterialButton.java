...
public class MaterialButton extends C0168s implements Checkable, w {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        super(p0.a.a(context, attributeSet, com.satellite.bigbang.R.attr.materialButtonStyle, com.satellite.bigbang.R.style.Widget_MaterialComponents_Button), attributeSet, com.satellite.bigbang.R.attr.materialButtonStyle);
        this.f1732e = new LinkedHashSet();
        this.f1741n = false;
        this.f1742o = false;
        Context context2 = getContext();
        TypedArray j2 = k.j(context2, attributeSet, X.a.f690k, com.satellite.bigbang.R.attr.materialButtonStyle, com.satellite.bigbang.R.style.Widget_MaterialComponents_Button, new int[0]);
        ...
        c cVar = new c(this, l.b(context2, attributeSet, com.satellite.bigbang.R.attr.materialButtonStyle, com.satellite.bigbang.R.style.Widget_MaterialComponents_Button).a());
        this.f1731d = cVar;
