...
public class NavigationMenuItemView extends e implements C {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet) {
        ...
        this.f1865E = dVar;
        setOrientation(0);
        LayoutInflater.from(context).inflate(com.satellite.bigbang.R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(com.satellite.bigbang.R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(com.satellite.bigbang.R.id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.f1870z == null) {
                this.f1870z = (FrameLayout) ((ViewStub) findViewById(com.satellite.bigbang.R.id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public final void c(q qVar) {
        ...
        if (getBackground() == null) {
            ...
            if (getContext().getTheme().resolveAttribute(com.satellite.bigbang.R.attr.colorControlHighlight, typedValue, true)) {
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.f1864D == null) {
                ...
                Drawable drawable2 = resources.getDrawable(com.satellite.bigbang.R.drawable.navigation_empty_icon, theme);
