...
public class MaterialTextView extends X {
    public MaterialTextView(Context context, AttributeSet attributeSet) {
        ...
        TypedValue l2 = k.l(context2, com.satellite.bigbang.R.attr.textAppearanceLineHeightEnabled);
    ...
    public final void setTextAppearance(Context context, int i2) {
        ...
        TypedValue l2 = k.l(context, com.satellite.bigbang.R.attr.textAppearanceLineHeightEnabled);
        if (l2 != null && l2.type == 18 && l2.data == 0) {
            return;
        }
