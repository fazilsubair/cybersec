    ...
    public final void d(View view, G.d dVar) {
        ...
        switch (i2) {
            ...
            case 1:
                ...
                accessibilityNodeInfo.setHintText(lVar.f1819b0.getVisibility() == 0 ? lVar.B().getResources().getString(R.string.mtrl_picker_toggle_to_year_selection) : lVar.B().getResources().getString(R.string.mtrl_picker_toggle_to_day_selection));
                break;
            default:
                accessibilityDelegate.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfo);
                accessibilityNodeInfo.setCollectionInfo(null);
