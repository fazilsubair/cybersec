...
class ClockFaceView extends f implements d {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, X.a.f683d, R.attr.materialClockStyle, R.style.Widget_MaterialComponents_TimePicker_Clock);
        ...
        this.f1957z = resources.getDimensionPixelSize(R.dimen.material_clock_hand_padding);
        int colorForState = f2.getColorForState(new int[]{android.R.attr.state_selected}, f2.getDefaultColor());
        this.f1955x = new int[]{colorForState, colorForState, f2.getDefaultColor()};
        clockHandView.f1958a.add(this);
        int defaultColor = B.a.x(context, R.color.material_timepicker_clockface).getDefaultColor();
        ...
        this.f1944A = resources.getDimensionPixelSize(R.dimen.material_time_picker_minimum_screen_height);
        this.f1945B = resources.getDimensionPixelSize(R.dimen.material_time_picker_minimum_screen_width);
        this.f1946C = resources.getDimensionPixelSize(R.dimen.material_clock_size);
    }
