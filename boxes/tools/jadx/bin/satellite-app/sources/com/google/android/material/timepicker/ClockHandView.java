...
class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, X.a.f684e, R.attr.materialClockStyle, R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.f1967j = obtainStyledAttributes.getDimensionPixelSize(1, 0);
        this.f1959b = obtainStyledAttributes.getDimensionPixelSize(2, 0);
        this.f1963f = getResources().getDimensionPixelSize(R.dimen.material_clock_hand_stroke_width);
        this.f1960c = r4.getDimensionPixelSize(R.dimen.material_clock_hand_center_dot_radius);
