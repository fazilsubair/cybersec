...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        ...
        this.f1751g = false;
        TypedArray j2 = k.j(getContext(), attributeSet, X.a.f691l, R.attr.materialButtonToggleGroupStyle, R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
