...
public class BottomSheetBehavior<V extends View> extends AbstractC0214a {
    ...
    */
    ...
    public final boolean g(CoordinatorLayout coordinatorLayout, View view, int i2) {
        ...
        if (this.f1693O == null) {
            this.f1708f = coordinatorLayout.getResources().getDimensionPixelSize(R.dimen.design_bottom_sheet_peek_height_min);
    ...
    public final void t(Context context, AttributeSet attributeSet, boolean z2, ColorStateList colorStateList) {
        if (this.f1710h) {
            this.f1722t = l.b(context, attributeSet, R.attr.bottomSheetStyle, R.style.Widget_Design_BottomSheet_Modal).a();
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.f1701W = -1;
        this.f1702X = new c(this);
        this.f1709g = context.getResources().getDimensionPixelSize(R.dimen.mtrl_min_touch_target_size);
