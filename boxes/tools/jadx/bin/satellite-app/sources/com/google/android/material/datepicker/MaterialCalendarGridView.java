...
final class MaterialCalendarGridView extends GridView {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet) {
        ...
        if (n.J(getContext(), R.attr.windowFullscreen)) {
            setNextFocusLeftId(com.satellite.bigbang.R.id.cancel_button);
            setNextFocusRightId(com.satellite.bigbang.R.id.confirm_button);
        }
        this.f1783a = n.J(getContext(), com.satellite.bigbang.R.attr.nestedScrollable);
